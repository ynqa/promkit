...
//!     - [Readline](https://github.com/ynqa/promkit/tree/v0.9.0#readline)
//!     - [Confirm](https://github.com/ynqa/promkit/tree/v0.9.0#confirm)
//!     - [Password](https://github.com/ynqa/promkit/tree/v0.9.0#password)
//!     - [Select](https://github.com/ynqa/promkit/tree/v0.9.0#select)
//!     - [QuerySelect](https://github.com/ynqa/promkit/tree/v0.9.0#queryselect)
//!     - [Checkbox](https://github.com/ynqa/promkit/tree/v0.9.0#checkbox)
//!     - [Tree](https://github.com/ynqa/promkit/tree/v0.9.0#tree)
...
//! ## Examples/Demos
//!
//! See [here](https://github.com/ynqa/promkit/tree/v0.9.0#examplesdemos)
//!
//! ## Why *promkit*?
//!
