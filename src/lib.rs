...
//!     - [Readline](https://github.com/ynqa/promkit/tree/v0.3.1#readline)
//!     - [Confirm](https://github.com/ynqa/promkit/tree/v0.3.1#confirm)
//!     - [Password](https://github.com/ynqa/promkit/tree/v0.3.1#password)
//!     - [Select](https://github.com/ynqa/promkit/tree/v0.3.1#select)
//!     - [QuerySelect](https://github.com/ynqa/promkit/tree/v0.3.1#queryselect)
//!     - [Checkbox](https://github.com/ynqa/promkit/tree/v0.3.1#checkbox)
//!     - [Tree](https://github.com/ynqa/promkit/tree/v0.3.1#tree)
...
//! ## Examples/Demos
//!
//! See [here](https://github.com/ynqa/promkit/tree/v0.3.1#examplesdemos)
//!
//! ## Why *promkit*?
//!
